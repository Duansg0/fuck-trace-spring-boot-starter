...
public abstract class AbstractConfiguration {
    ...
    protected void init(TraceProperties traceProperties) {
        ...
        TraceUtil.setPerproteyByTrue(traceProperties.isTraceSwitchDubbo(),TraceConstants.DIGEST_LOG_SWITCH_DUBBO,String.valueOf(traceProperties.isTraceSwitchDubbo()));
